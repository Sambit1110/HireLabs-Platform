...
The active app is the Next.js implementation above. The root `index.html`, `signup.html`, `app.js`, `style.css`, and `supabase.js` files are retained only as the original static prototype; see [`legacy/README.md`](legacy/README.md).
